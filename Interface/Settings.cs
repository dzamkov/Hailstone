...
namespace Hailstone.Interface
{
    ...
    public class Settings
    {
        ...
        /// <summary>
        /// Gets the available settings options.
        /// </summary>
        ...
        {
            string path = "Settings\\" + Name + ".lua";
            using (FileStream stream = File.OpenWrite(path))
                Serialization.Save("Settings", Settings.Default, Settings, stream);
        }
        ...
        /// </summary>
        public static bool Load(string Name, ref Settings Settings)
        {
            string path = "Settings\\" + Name + ".lua";
            if (File.Exists(path))
            {
                using (FileStream stream = File.OpenRead(path))
                    Serialization.Load("Settings", ref Settings.Current, stream);
                return true;
            }
            else
            {
